...
/**
 * Internal visibility is good for code that needs to be accessed in many different packages
 * but not by external programs/modules
 */
...
//the purpose of this function is to eliminate the need of
